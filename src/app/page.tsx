    ...
    <main className="min-h-screen">
        ...
        <Card id="home" backgroundColor='dark:bg-gray-950 bg-gray-100'>
          <div className="pl-5 md:pl-14 xl:pl-[12.5rem] flex flex-col min-w-[50%} md:w-[90%]">
            ...
            <p className='dark:text-white text-black pl-1 text-lg font-medium'>A Junior Full-Stack Developer focused on building innovative and scalable web solutions.</p>
          </div>
        ...
        <Card id="projects" backgroundColor='dark:bg-gray-950 bg-gray-100'>
            <h2 className='self-center pb-8 md:text-5xl text-4xl dark:text-white text-black items-stretch'>Projects</h2>
          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className='flex flex-col md:flex-row space-y-4 md:space-y-0 justify-between dark:text-white ml-auto mr-auto'>
              <div className='flex flex-col items-center md:pr-8'>
                ...
                <p className='pointer-events-none pt-1 dark:text-white text-black'>sajan.basra2k@gmail.com</p>
              </div>
              ...
              <div className='flex flex-col items-center pb-8'>
                ...
                <p className='pointer-events-none pt-1 dark:text-white text-black'>+44 07848915455</p>
              </div>
            </div>
          </div>
        </Card>
